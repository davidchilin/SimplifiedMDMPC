...
public class SeqMPCControl_FDI4 {
	public static void main(String[] args) {
		...
		int cc = 1600; // simulation time
		int lcc = 1600; // cost counter end time
...
// Begin Plant Simulation ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
			for (int i = 0; i < cc; i++) {
				...
				if (detected == -1) { // if fault is not isolated, continue with 
					if (i > cc / 4) { // initiate actuator fault here ^^^
						if (i-2 < cc / 4) System.out.print("Fault Triggered at:" + i);
						
						uk_f[0] = -.99; // F4, F6
						//uk[2]=0.5;  // Q1, Q2, Q3, Q4, Q5
					}
				}
