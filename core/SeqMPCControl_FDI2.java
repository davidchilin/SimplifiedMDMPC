...
public class SeqMPCControl_FDI2 {
	public static void main(String[] args) {
		...
		int lcc = 1000; // cost counter time
		...
		String rfile = "./data/newsim2/seq_r_n" + N + "_nc" + nc + ".data";
...
//			rdisplay[i] = i;
		...
		int ii=0;
		for (int i : rdisplay) {
			rlimits[ii][0] = average[i] - 3 * stdev[i];
			rlimits[ii++][1] = average[i] + 3 * stdev[i];
		}
		...
		try {
			...
			for (int i = 0; i < cc; i++) {
				...
				if (detected == -1) {// if not detected - perform FDI
					ii=0;
					for (int j : rdisplay) {
						if (r[i][ii] < rlimits[ii][0] || r[i][ii] > rlimits[ii++][1]) { // residual exceed threshold
			...
			new PlotIt5("Temperatures", Stuff.Reverse(x), t,tdisplay,1).plot();
			new PlotIt5("Control Inputs", Stuff.Reverse(u), t, udisplay,1).plot();
			// new PlotIt5("fTemperatures", f1x, t, display,1).plot(); // fdi
			// new PlotIt5("fControl Inputs", f1u, t, udisplay,1).plot(); // fdi
			new PlotIt5("ResidualsPI5",Stuff.Reverse(r),t,abc).plot();
			// new PlotIt5("aResiduals", r, t, adisplay,1).plot(); // fdi
			// new PlotIt5("bResiduals", r, t, bdisplay,1).plot(); // fdi
			// new PlotIt5("cResiduals", r, t, cdisplay,1).plot(); // fdi
			// new PlotIt5("dResiduals", r, t, ddisplay,1).plot(); // fdi
			// new PlotIt5("tResiduals", r, t, tdisplay,1).plot(); // fdi
